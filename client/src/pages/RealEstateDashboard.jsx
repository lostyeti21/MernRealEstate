...
export default function RealEstateDashboard() {
  ...
  useEffect(() => {
    if (!listings.length || activeTab !== 'analytics') return;
        ...
        <div>
          ...
          <div className="bg-white p-4 rounded-lg shadow mb-8">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a 
                  href="#price-competitiveness-analytics" 
                  className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                  onClick={(e) => {
                    e.preventDefault();
                    document.getElementById('price-competitiveness-analytics').scrollIntoView({ behavior: 'smooth' });
                  }}
                >
                  Price Competitiveness Analytics
                </a>
              </li>
              <li>
                <a 
          ...
          {/* Price Competitiveness Analytics */}
          <div id="price-competitiveness-analytics" className="mt-8">
            <h3 className="text-xl font-semibold mb-4">Price Competitiveness Analytics</h3>
          ...
          {/* Location-based Price Analytics */}
          <div className="mt-8">
            <h3 className="text-xl font-semibold mb-4">Price Analytics by Location</h3>
