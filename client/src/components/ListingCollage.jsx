  ...
  return (
    <div className="mb-16 bg-white rounded-lg shadow-xl overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Link to={`/listing/${listing._id}`} className="relative h-[400px] md:h-[500px] overflow-hidden group cursor-pointer">
          <div
        ...
        <div className="grid grid-rows-2 gap-4 p-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h4 className="text-lg font-semibold text-gray-800 mb-3">Property Features</h4>
